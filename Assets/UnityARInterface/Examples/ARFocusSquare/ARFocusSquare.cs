...
namespace UnityARInterface
{
	public class ARFocusSquare : MonoBehaviour {
		...
		void Update () {
            ...
            //if (_camController.IsHitARObject)
            //    return;
        ...
        /// <summary>
        /// Retorna el Transform de la locacion (Square Focus) mostrada en pantalla.
        /// </summary>
        /// <returns>Retorna un transform del (Square Focus).</returns>
        public Transform GetTransformLocation()
        {
